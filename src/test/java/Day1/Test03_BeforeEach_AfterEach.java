...
public class Test03_BeforeEach_AfterEach {
    ...
    void testArrays(TestInfo info){
        ...
        System.out.println(info.getDisplayName()+ "calisti"); // calisan test methodunu veriyor hangi test methodu calistiysa onu veriyo
        assertTrue(Arrays.equals(beklenenDizi,anlikDizi));
    }

    @Test
    void testStringLength( TestInfo info){  //before each her test methodunun onunde calisir
